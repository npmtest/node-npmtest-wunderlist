...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-wunderlist/node_modules/wunderlist/public/services/Memberships.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-wunderlist/node_modules/wunderlist/public/services/Memberships.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-wunderlist/node_modules/wunderlist/public/services/</a> &#187; Memberships.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    self.userService = new UserService(options);</span>
  },
&nbsp;
  'mine': <span class="fstat-no" title="function not covered" >function () {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var self = this;</span>
<span class="cstat-no" title="statement not covered" >    var deferred = new WBDeferred();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    self.userService.all()</span>
      .done(<span class="fstat-no" title="function not covered" >function (userData) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        self.forUser(userData.id)</span>
