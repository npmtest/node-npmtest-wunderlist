...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-wunderlist/node_modules/wunderlist/public/services/Subtasks.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-wunderlist/node_modules/wunderlist/public/services/Subtasks.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-wunderlist/node_modules/wunderlist/public/services/</a> &#187; Subtasks.js</div>
</div>
<div class="body">
...
&nbsp;
  /**
    ...
    * @param {string} [requestID] - User supplied Request ID. Autogenerated if not supplied.
    */
  'forList': <span class="fstat-no" title="function not covered" >function (listId, completed, requestID) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var request = self.get(self.baseUrl, {</span>
      'list_id': listId,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var hasData = Object.keys(data).length;</span>
<span class="cstat-no" title="statement not covered" >    var required = ' required for subtask creation';</span>
<span class="cstat-no" title="statement not covered" >    assert(hasData, 'data' + required);</span>
<span class="cstat-no" title="statement not covered" >    assert.number(data.task_id, 'data.task_id' + required);</span>
<span class="cstat-no" title="statement not covered" >    assert.string(data.title, 'data.title' + required);</span>
  }
});
&nbsp;
&nbsp;</pre></td></tr>
